...
const services = [
  {
    ...
    text: 'From nagging repairs to the odd jobs that never leave the list.',
    items: [
  ...
  {
    icon: Hammer,
    title: 'Carpentry & Exterior',
    text: 'Repairs and improvements that keep the outside of your home working and looking right.',
    items: [
      'Deck & porch repair',
      'Steps & railings',
      'Fence & gate repair',
      'Wood & trim repair',
      'Shed repairs',
      'Small custom carpentry',
    ],
  },
  {
    icon: Bath,
    title: 'Kitchen & Bathroom',
    text: 'Practical updates, repairs, tile work, and fixture replacements.',
    items: [
      'Kitchen repairs',
      'Bathroom repairs',
      'Tile & backsplashes',
  ...
  {
    icon: Paintbrush,
    title: 'Walls, Floors & Finishing',
    text: 'The finishing work that makes a room feel complete again.',
    items: [
      'Painting & touch-ups',
      'Drywall repair',
      'Flooring repair',
  ...
  {
    icon: Drill,
    title: 'Installation & Improvements',
    text: 'New fixtures, hardware, and home improvements installed with care.',
    items: [
      'Light fixtures',
      'Ceiling fans',
      'TV mounting',
      'Blinds & curtain hardware',
      'Grab bars',
      'Weatherproofing',
    ],
  },
...
const projects = [
  {
    ...
    summary: 'From overgrown space to a finished outdoor area.',
    cover: yardAfter2,
    photos: [yardBefore, yardDuring, yardAfter, yardAfter2],
  },
  {
    title: 'Deck repair',
    summary: 'Repair work from progress through the finished result.',
    cover: deckAfter,
    photos: [deckBefore, deckDuring, deckAfter],
  },
  {
    title: 'Tile and shower work',
    summary: 'Interior tile and shower improvement work.',
    cover: shower,
    photos: [shower],
  },
  {
    title: 'Home repair work',
    summary: 'Hands-on repair work in progress.',
    cover: concrete,
    photos: [concrete],
  },
];
...
function App() {
  ...
  function changeLightboxPhoto(direction) {
    setLightbox((current) => {
      ...
      return {
        ...current,
        photoIndex: (current.photoIndex + direction + total) % total,
      };
    });
  }
  ...
  async function submitEstimate(event) {
    ...
    selectedPhotos.forEach(({ file }) =>
      formData.append('Project photos[]', file),
    );

    try {
      const response = await fetch(
        'https://formsubmit.co/ajax/reiderhomeservices@gmail.com',
        {
          method: 'POST',
      ...
      setFormMessage(
        'Thanks — your request has been sent. Chris will review it and get back to you.',
      );
    } catch {
      setFormStatus('error');
      setFormMessage(
        'We could not send your request. Please call, text, or email us instead.',
      );
    }
  }
  return (
    <>
        ...
        <section className='hero'>
          ...
          <div className='heroContent'>
            ...
            <p className='lead'>
              ...
              house you just need done right.
            </p>
        ...
        <section className='processSection' id='how-it-works'>
          <div className='section processInner'>
            <div className='sectionHead processHead'>
              ...
              <p>
                Getting started is simple. Tell us what your home needs, and
                Chris will help you work out the next step.
              </p>
            </div>
            <div className='processGrid'>
              <article className='processStep'>
                ...
                <p>
                  Use the estimate form, call, or text. Photos are helpful, but
              ...
              <article className='processStep'>
                ...
                <p>
                  He'll ask any needed questions and discuss the scope,
                  location, and timing with you.
                </p>
              </article>
              <article className='processStep'>
                ...
                <h3>Plan the work</h3>
                <p>
                  If the project is a good fit, you'll arrange the estimate and
        ...
        <section className='section' id='services'>
          ...
          <div className='ask'>
            <div>
              ...
              <p>
                If something in your home needs to be repaired, fixed,
                installed, replaced, or improved, just ask.
              </p>
            </div>
        ...
        <section className='work' id='our-work'>
          <div className='section workInner'>
            <div className='sectionHead light'>
              ...
              <p>
                Real work from Reider Home Services — not stock photography.
              </p>
            </div>
            <div className='compare'>
              <div
                className='sideBySideCompare'
                aria-label='Outdoor project before and after photos'>
                <figure>
                  <span>BEFORE</span>
                  <img
                    src={yardBefore}
                    alt='Outdoor area before the improvement work'
                  />
                </figure>
                <figure>
                  <span>AFTER</span>
                  <img
                    src={yardAfterComparison}
                    alt='Outdoor area after the improvement work'
                  />
                </figure>
              </div>
              <div className='compareCopy'>
                ...
                <p>
                  Compare the full project photos side by side, from the
                  overgrown starting point to the cleared and finished space.
                </p>
              </div>
            </div>
            <div className='projectGallery'>
              {projects.map((project, projectIndex) => (
                <button
                  ...
                  key={project.title}
                  type='button'
                  onClick={() => setLightbox({ projectIndex, photoIndex: 0 })}>
                  ...
                  <span className='projectCardCopy'>
        ...
        <section className='faqSection' id='faq'>
          <div className='section faqInner'>
            ...
            <div className='faqList'>
              <details>
                <summary>
                  What kinds of projects does Reider Home Services take on?
                </summary>
                <p>
                  Chris handles a wide range of home repairs, installations,
                  maintenance, carpentry, painting, drywall, tile, and
                  improvement projects. If you aren't sure whether your job
                  fits, send a short description and ask.
                </p>
              </details>
              <details>
                <summary>Do you take smaller repair jobs?</summary>
                <p>
                  Yes. Reider Home Services is built for both individual repairs
                  and lists of smaller jobs that homeowners need help
                  completing.
                </p>
              </details>
              <details>
                ...
                <p>
                  Yes. You can attach a photo to the estimate request form. A
                  clear photo can help Chris understand the project before
                  following up.
                </p>
              </details>
              <details>
                <summary>
                  Do I need to know exactly what the repair requires?
                </summary>
                <p>
                  No. Describe what you see, what isn't working, or what you
                  want changed. Chris can ask follow-up questions and help
              ...
              <details>
                ...
                <p>
                  Complete the estimate form below or call or text (610)
                  609-2427. Include the type of project, your general location,
                  and your preferred way to be contacted.
                </p>
              </details>
            </div>
          </div>
        ...
        <section className='reviewsSection' id='reviews'>
          <div className='section reviewsInner'>
            <div className='sectionHead reviewsHead'>
              ...
              <p>
                We’re beginning to collect feedback from completed projects.
              </p>
            </div>
            <div className='reviewsEmpty'>
              ...
              <p>
                Had work completed by Reider Home Services? We’d be glad to hear
                about your experience.
              </p>
              <a
                className='textLink blueLink'
                href='mailto:reiderhomeservices@gmail.com?subject=Reider%20Home%20Services%20review'>
        ...
        <section className='contact' id='contact'>
          <div className='contactInner'>
            <div className='contactIntro'>
              ...
              <p>
                Share a few details and Chris will follow up to discuss the
                work, timing, and next steps. You don't need to know exactly
                what the repair requires — just tell us what you're seeing.
              </p>
              <div className='availabilityCard'>
                <Clock3 />
                <div>
                  <strong>Scheduling and availability</strong>
                  <p>
                    Chris reviews each request personally. Availability depends
                    on the type of work and project location, and scheduling is
                    confirmed during follow-up. Submitting this form does not
            ...
            <form
              ...
              <input
                type='hidden'
                name='_subject'
                value='New estimate request from the Reider Home Services website'
              />
              ...
              <div className='fieldGrid'>
                ...
                <label>
                  ...
                  <select name='Service needed' defaultValue='' required>
                    ...
                    <option>General home repair</option>
                    <option>Carpentry or exterior work</option>
                    <option>Kitchen or bathroom</option>
                    <option>Painting, drywall, or finishing</option>
                    <option>Installation or improvement</option>
                    <option>Other / Not sure</option>
                  </select>
                </label>
                <label>
                  City or ZIP code <span>*</span>
                  <input
                ...
                <label className='fullField'>
                  ...
                  <select name='Preferred timeframe' defaultValue='Flexible'>
                ...
                <label className='fullField'>
                  Tell us about the project <span>*</span>
                  <textarea
                    name='Project details'
                    rows='5'
                    placeholder='What needs to be repaired, installed, or improved?'
                    required
                  />
                </label>
                <label className='fullField fileField'>
                  Add photos <small>(optional, up to 3)</small>
                  <input
                    type='file'
                ...
                {selectedPhotos.length > 0 && (
                  <div
                    className='fullField photoPreviews'
                    aria-label='Selected project photos'>
              ...
              <p className='formPrivacy'>
                Please don't include payment details or other sensitive
                information.
              </p>
              <button
              ...
              {formMessage && (
                <div
                  className={`formNotice ${formStatus}`}
                  role='status'
                  aria-live='polite'>
                  {formMessage}
                  {formStatus === 'error' && (
                    <a href='tel:+16106092427'>Call or text (610) 609-2427</a>
                  )}
                </div>
              )}
            </form>
      ...
      {lightbox && (
        <div
          ...
          role='dialog'
          aria-modal='true'
          aria-label={`${projects[lightbox.projectIndex].title} photo gallery`}
          onMouseDown={(event) => {
          ...
          <div className='lightboxContent'>
            <img
              src={projects[lightbox.projectIndex].photos[lightbox.photoIndex]}
              alt={`${projects[lightbox.projectIndex].title}, photo ${lightbox.photoIndex + 1} of ${projects[lightbox.projectIndex].photos.length}`}
            />
            <div className='lightboxCaption'>
              <div>
                <strong>{projects[lightbox.projectIndex].title}</strong>
                <span>
                  Photo {lightbox.photoIndex + 1} of{' '}
                  {projects[lightbox.projectIndex].photos.length}
                </span>
              </div>
            </div>
          </div>
